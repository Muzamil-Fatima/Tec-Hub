...
const CourseModal = ({ course, closeModel }) => {
  const modelDetails = [...course.shortDetail, ...course.longDetail];
  return (
      <div className="bg-white p-6 rounded-xl wrap-break-word">
